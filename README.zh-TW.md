...
| <img src=".github/assets/tools-icon/commandcode.png" width="28" alt="Command Code" /> | Command Code | `~/.commandcode/projects/**/*.jsonl`；Command Code dashboard cookie（透過 Command Code billing API 查詢 5 小時／每週／每月 credits） | ✅ | ✅ | — |
