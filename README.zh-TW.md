...
| <img src=".github/assets/tools-icon/doubao.png" width="28" alt="豆包工作" /> | 豆包工作 | 豆包工作桌面應用（內建 CDP 除錯連接埠） | — | ✅ | — |
...
- **AI 工具額度偵測**：涵蓋 Claude Code、Codex、Cursor、OpenRouter、第三方 API、GLM、Kimi 等 22+ 家供應商的 session、每週、帳單與 credits 視窗，支援多個 OpenRouter／第三方 profile，以及 DeepSeek 預付餘額與消費
