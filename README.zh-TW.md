...
| <img src=".github/assets/tools-icon/reasonix.png" width="28" alt="Reasonix" /> | Reasonix | 聚合用量：`$REASONIX_STATE_HOME/stats/` → `$REASONIX_HOME/stats/` → 平台預設路徑（Tokscale）；原生明細中繼資料：`sessions/`、`projects/*/sessions/` | ✅ | — | — |
