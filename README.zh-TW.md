...
| <img src=".github/assets/tools-icon/workbuddy.png" width="28" alt="WorkBuddy" /> | WorkBuddy | `~/.workbuddy/projects/`、`~/.workbuddy/workbuddy.db`；自動偵測已登入的 WorkBuddy 桌面應用程式並讀取帳單餘額（支援 macOS/Windows，Linux 不支援） | ✅ | ✅ | — |
