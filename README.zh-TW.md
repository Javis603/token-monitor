...
| <img src=".github/assets/tools-icon/minimax.png" width="28" alt="Minimax" /> | Minimax | `~/.minimax/v2/sessions/**/messages.jsonl`；Minimax API 金鑰（透過 Minimax API 查詢 Token Plan 額度） | ✅ | ✅ | — |
