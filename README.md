...
| <img src=".github/assets/tools-icon/workbuddy.png" width="28" alt="WorkBuddy" /> | WorkBuddy | `~/.workbuddy/projects/`, `~/.workbuddy/workbuddy.db`; automatically detects the signed-in WorkBuddy desktop app for billing balance (macOS/Windows; Linux unsupported) | ✅ | ✅ | — |
