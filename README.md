...
| <img src=".github/assets/tools-icon/trae.png" width="28" alt="Trae CN" /> | Trae CN | Manual access token (Trae CN / SOLO credits via the trae.cn API; no local session detection) | — | ✅ | — |
