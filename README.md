...
| <img src=".github/assets/tools-icon/mavis.png" width="28" alt="Minimax Code" /> | Minimax Code | `~/.minimax/v2/sqlite/runtime-state.sqlite` (pi-agent local SQLite, WAL-safe) | ✅ | — | — |
