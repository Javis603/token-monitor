...
| <img src=".github/assets/tools-icon/minimax.png" width="28" alt="Minimax" /> | Minimax | `~/.minimax/v2/sessions/**/messages.jsonl`; Minimax API key (Token Plan quota via Minimax API) | ✅ | ✅ | — |
