...
- **계정별 사용량 귀속** — 세션에 계정 ID가 기록되는 도구(현재 WorkBuddy)는 사용량을 해당 계정에 기록합니다. 로그아웃 후 다른 계정으로 전환해도 계정 보기에서는 각 계정의 기록이 따로 유지되며, 도구 합계는 모든 계정의 총합으로 유지됩니다
- **분류 보기** — 도구, 기기, 모델, 프로젝트, 계정, 세션, 계정 한도별
