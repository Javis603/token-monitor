...
- **AI 도구 한도 감지** — Claude Code, Codex, Cursor, OpenRouter, 서드파티 API, GLM, Kimi 등 19개 이상 공급자의 session/weekly/billing/credits, WorkBuddy 로컬 앱 로그인과 결제 잔액, 여러 OpenRouter/서드파티 프로필, DeepSeek 선불 잔액과 사용액
