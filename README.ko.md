...
| <img src=".github/assets/tools-icon/commandcode.png" width="28" alt="Command Code" /> | Command Code | `~/.commandcode/projects/**/*.jsonl`; Command Code dashboard cookie (Command Code billing API로 5시간/주간/월간 credits 조회) | ✅ | ✅ | — |
