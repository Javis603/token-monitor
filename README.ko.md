...
| <img src=".github/assets/tools-icon/workbuddy.png" width="28" alt="WorkBuddy" /> | WorkBuddy | `~/.workbuddy/projects/`, `~/.workbuddy/workbuddy.db`; 로그인된 WorkBuddy 데스크톱 앱을 자동 감지해 결제 잔액 확인 (macOS/Windows 지원, Linux 미지원) | ✅ | ✅ | — |
