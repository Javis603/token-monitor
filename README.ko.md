...
- **구독 기록** — 각 AI 계정에 실제로 지불하는 금액을 직접 기록하고, 해당 계정의 요금제 라벨에 마우스를 올리면 가격, 갱신일 또는 종료일, 이용 기간, 이번 달 사용량과 요금제 비용의 비교를 확인할 수 있습니다. 정기 요금제와 충전 내역을 모두 지원하며, 허브를 설정하면 연결된 모든 기기가 같은 목록을 공유합니다
