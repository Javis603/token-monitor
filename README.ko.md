...
| <img src=".github/assets/tools-icon/minimax.png" width="28" alt="Minimax" /> | Minimax | `~/.minimax/v2/sessions/**/messages.jsonl`; Minimax API 키 (Minimax API로 Token Plan 할당량 조회) | ✅ | ✅ | — |
