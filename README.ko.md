...
| <img src=".github/assets/tools-icon/commandcode.png" width="28" alt="Command Code" /> | Command Code | `~/.commandcode/projects/**/*.jsonl`, Command Code 대시보드 쿠키(Command Code 빌링 API로 5시간·주간·월간 credits) | ✅ | ✅ | — |
