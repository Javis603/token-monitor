...
- Self-synced clients (cursor/antigravity) additionally go in `SELF_SYNCED_CLIENTS`; parse-local clients (proma, dsh) must NOT, and must be stripped from the Tokscale client filter.
