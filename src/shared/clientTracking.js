...
const PARSE_LOCAL_CLIENTS = Object.freeze(['proma', 'qodercn', 'clacky']);
const DEFAULT_CLIENTS = 'claude,codex,opencode,hermes,openclaw,clacky,cursor,antigravity,cline,kimi,qwen,grok,copilot,pi,zed,kilocode,commandcode,zcode,kiro,codebuddy,workbuddy,proma,reasonix,dsh,cherrystudio';
