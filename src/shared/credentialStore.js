...
const CREDENTIAL_SETTING_PATHS = Object.freeze({
  ...
  workbuddyAccessToken: ['providers', 'workbuddy', 'accessToken'],
  workbuddyUid: ['providers', 'workbuddy', 'uid'],
  traeWorkAccessToken: ['providers', 'traework', 'accessToken'],
  traeWorkDeviceId: ['providers', 'traework', 'deviceId'],
