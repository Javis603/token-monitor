...
(function exposeUsageCharts(root, factory) {
  ...
  // A vendor shares one colour with the client it names (moonshot/kimi, zai/zaiteam,
  // xai/grok), so `xiaomi` stays black alongside its `micode` row: `modelVendorFor`
  // routes MiMo models to this vendor key, and Xiaomi's orange is the corporation's
  // mark rather than the product's.
  const clientColors = {
