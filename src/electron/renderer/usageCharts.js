...
(function exposeUsageCharts(root, factory) {
  ...
  const clientColors = {
    ...
    droid: '#000000', kimi: '#16191e', qwen: '#615ced', grok: '#000000', copilot: '#000000', pi: '#000', zed: '#4173e7', kilo: '#F8F676', commandcode: '#8C4EDD', micode: '#000000', zcode: '#000000', kiro: '#9046FF', codebuddy: '#6C4DFF', workbuddy: '#0DC8A5', proma: '#000000', qodercn: '#2ADB5C', reasonix: '#4d6bfe', dsh: '#4d6bfe', cherrystudio: '#EA5E5D', lmstudio: '#6C5CE7', unsloth: '#40B85A', mavis: '#f23f5d',
