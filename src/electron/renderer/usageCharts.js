...
(function exposeUsageCharts(root, factory) {
  ...
  const clientColors = {
    ...
    moonshot: '#16191e', zai: '#000000', zaiteam: '#000000', cohere: '#39594d', xiaomi: '#ff6700', minimax: '#f23f5d', doubao: '#1E37FC', hunyuan: '#0053E0', volcengine: '#006EFF', volcagent: '#006EFF', qoder: '#2ADB5C', trae: '#32F08C', ollama: '#888888', thirdparty: '#8090A6',
    default: '#6ab4f0'
  };
