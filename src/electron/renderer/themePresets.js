...
(function exposeThemePresets(root, factory) {
  ...
  const VENDOR_ORDER = [
    ...
    'gemini', 'antigravity', 'kimi', 'qwen', 'grok', 'copilot', 'pi', 'dsh', 'zed', 'kilocode', 'commandcode', 'micode', 'zcode', 'kiro', 'codebuddy', 'workbuddy', 'proma', 'reasonix', 'deepseek', 'xai', 'meta', 'mistral',
