...
const LIMIT_PROVIDER_SETTING_KEYS = Object.freeze({
  ...
  workbuddy: ['workbuddyAccessToken', 'workbuddyUid'],
  traework: ['traeWorkAccessToken', 'traeWorkDeviceId'],
...
function limitsConfigFromSettings(settings = {}, context = {}) {
  ...
  return {
    ...
    workbuddyAccessToken: settings.workbuddyAccessToken || '',
    workbuddyUid: settings.workbuddyUid || '',
    traeWorkAccessToken: settings.traeWorkAccessToken || '',
    traeWorkDeviceId: settings.traeWorkDeviceId || '',
