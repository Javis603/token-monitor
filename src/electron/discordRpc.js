...
const KNOWN_CLIENT_ASSETS = new Set([
  ...
  'kimi', 'qwen', 'grok', 'copilot', 'pi', 'dsh', 'zed', 'kilocode', 'commandcode', 'micode', 'zcode', 'kiro', 'codebuddy', 'workbuddy', 'proma', 'reasonix'
]);
const CLIENT_LABELS = {
  ...
  pi: 'Pi', dsh: 'DeepSeek Harness', zed: 'Zed', kilocode: 'Kilo Code', commandcode: 'Command Code', micode: 'MiMo Code', zcode: 'ZCode', kiro: 'Kiro', codebuddy: 'CodeBuddy', workbuddy: 'WorkBuddy', proma: 'Proma', reasonix: 'Reasonix'
};
