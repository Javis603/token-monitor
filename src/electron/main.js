...
// costs a timer and a brief flicker on every app switch. That price only makes
// sense for someone who deliberately parked the widget on the taskbar, which is
// why it is opt-in; windowsTaskbarZOrder.js explains the mechanics. Everything
// that can change whether the widget still overlaps the taskbar — or is still
// on top, or still visible — calls this, and the keeper decides for itself.
