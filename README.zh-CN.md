...
| <img src=".github/assets/tools-icon/doubao.png" width="28" alt="豆包工作" /> | 豆包工作 | 豆包工作桌面应用（内置 CDP 调试端口） | — | ✅ | — |
...
- **AI 工具额度检测**：涵盖 Claude Code、Codex、Cursor、OpenRouter、第三方 API、GLM、Kimi 等 22+ 家提供方的 session、每周、账单与 credits 窗口，支持多个 OpenRouter／第三方 profile，以及 DeepSeek 预付余额与消费
