...
| <img src=".github/assets/tools-icon/workbuddy.png" width="28" alt="WorkBuddy" /> | WorkBuddy | `~/.workbuddy/projects/`、`~/.workbuddy/workbuddy.db`；自动检测已登录的 WorkBuddy 桌面应用并读取账单余额（支持 macOS/Windows，Linux 不支持） | ✅ | ✅ | — |
