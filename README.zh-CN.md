...
| <img src=".github/assets/tools-icon/mavis.png" width="28" alt="Mavis (MiniMax Code)" /> | Mavis (MiniMax Code) | `~/.minimax/v2/sqlite/runtime-state.sqlite`（pi-agent 本地 SQLite，WAL 安全） | ✅ | — | ✅ |
