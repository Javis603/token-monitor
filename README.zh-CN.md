...
- **AI 工具额度检测**：涵盖 Claude Code、Codex、Cursor、OpenRouter、第三方 API、GLM、Kimi 等 19+ 家提供方的 session、每周、账单与 credits 窗口，支持 WorkBuddy 读取本机应用登录状态并查询账单余额、多个 OpenRouter／第三方 profile，以及 DeepSeek 预付余额与消费
