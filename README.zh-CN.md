...
| <img src=".github/assets/tools-icon/minimax.png" width="28" alt="Minimax" /> | Minimax | `~/.minimax/v2/sessions/**/messages.jsonl`；Minimax API 密钥（通过 Minimax API 查询 Token Plan 额度） | ✅ | ✅ | — |
