...
| <img src=".github/assets/tools-icon/commandcode.png" width="28" alt="Command Code" /> | Command Code | `~/.commandcode/projects/**/*.jsonl`；Command Code 仪表板 cookie（通过 Command Code 账务 API 获取 5 小时、每周与每月 credits）| ✅ | ✅ | — |
