...
`limits.providers[].provider` is one of `claude`, `codex`, `cursor`, `antigravity`, `opencode`, `deepseek`, `minimax`, `grok`, `copilot`, `kiro`, `zai`, `volcengine`, `qoder`, or `kimicoding`.
