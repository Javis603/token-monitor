...
`limits.providers[].provider` is one of `claude`, `codex`, `cline`, `factory`, `cursor`, `antigravity`, `opencode`, `openrouter`, `deepseek`, `minimax`, `mimo`, `grok`, `copilot`, `kiro`, `commandcode`, `zai`, `zaiteam`, `volcengine`, `qoder`, `workbuddy`, `kimi`, `ollama`, `alibaba`, or `thirdparty`.
