...
- `projectsIncomplete` plus `devices[].allTimeProjectsOmitted` when one or more device rollups were intentionally dropped to preserve core sync under the ingest budget
