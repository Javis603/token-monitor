...
# Desktop Local App monitoring is explicitly enabled in Token Monitor Settings on
# macOS and Windows; Linux Local App monitoring is unsupported. Desktop users do
