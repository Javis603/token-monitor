...
| **Appearance** | Interface theme (presets such as Default and Obsidian, a porcelain light mode, or custom colors), per-vendor tool colors, system glass opacity / blur (on macOS 26+, Frosted Glass or native Liquid Glass), and separate interface and display fonts. |
