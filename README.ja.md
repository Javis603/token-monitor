...
| <img src=".github/assets/tools-icon/commandcode.png" width="28" alt="Command Code" /> | Command Code | `~/.commandcode/projects/**/*.jsonl`; Command Code dashboard cookie（Command Code billing API で 5時間/週次/月次 credits 取得） | ✅ | ✅ | — |
