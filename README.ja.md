...
| <img src=".github/assets/tools-icon/reasonix.png" width="28" alt="Reasonix" /> | Reasonix | 集計: `$REASONIX_STATE_HOME/stats/` → `$REASONIX_HOME/stats/` → プラットフォーム既定（Tokscale）；ネイティブ詳細メタデータ: `sessions/`、`projects/*/sessions/` | ✅ | — | — |
