...
| <img src=".github/assets/tools-icon/workbuddy.png" width="28" alt="WorkBuddy" /> | WorkBuddy | `~/.workbuddy/projects/`, `~/.workbuddy/workbuddy.db`; サインイン済みの WorkBuddy デスクトップアプリを自動検出して請求残高を確認（macOS/Windows 対応、Linux 非対応） | ✅ | ✅ | — |
