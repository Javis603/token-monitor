...
| <img src=".github/assets/tools-icon/doubao.png" width="28" alt="Doubao Work" /> | Doubao Work | Doubao Work デスクトップアプリ（内蔵 CDP デバッグポート） | — | ✅ | — |
...
- **AI ツール制限検出** — Claude Code、Codex、Cursor、OpenRouter、サードパーティAPI、GLM、Kimi など 22+ プロバイダーの session/weekly/billing/credits、複数の OpenRouter／サードパーティプロファイル、DeepSeek プリペイド残高と使用額
