...
| <img src=".github/assets/tools-icon/commandcode.png" width="28" alt="Command Code" /> | Command Code | `~/.commandcode/projects/**/*.jsonl`、Command Code ダッシュボードの cookie（Command Code 課金 API 経由で 5 時間・週次・月次 credits）| ✅ | ✅ | — |
