...
| <img src=".github/assets/tools-icon/minimax.png" width="28" alt="Minimax" /> | Minimax | `~/.minimax/v2/sessions/**/messages.jsonl`；Minimax API キー（Minimax API で Token Plan クォータ取得） | ✅ | ✅ | — |
