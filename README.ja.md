...
- **アカウント別の使用量帰属** — セッションにアカウント ID が記録されるツール（現在は WorkBuddy）は、使用量をそのアカウントに計上します。サインアウトして別アカウントに切り替えても、アカウントビューでは各アカウントの履歴が別々に保持され、ツール合計は全アカウントの合計のままです
- **内訳ビュー** — ツール、デバイス、モデル、プロジェクト、アカウント、セッション、アカウント制限別
